  ...
  return (
    <section >
      ...
      <div className='grid grid-cols-1 lg:grid-cols-3  gap-8 px-6'>
        <div className='  border border-gray-400 mx-auto rounded-xl px-8 py-8 cursor-pointer hover:shadow-xl hover:-translate-y-2 hover:transform duration-200 transition-transform '>
